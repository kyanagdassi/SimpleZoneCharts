...
def formation_efficiencies(data):
  ...
  for key in list(formation_dictionary):
    if len(formation_dictionary[key]) <= 2:
      formation_dictionary.pop(key)
  formation_average = {}
